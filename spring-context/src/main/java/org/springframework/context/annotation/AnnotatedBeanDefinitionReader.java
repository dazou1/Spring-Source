...
public class AnnotatedBeanDefinitionReader {
	...
	/**
	 * 因为传入的是 this 对象，也就是 AnnotationConfigApplicationContext 的实例
	 * 这里的BeanDefinitionRegistry当然就是 AnnotationConfigApplicationContext 的实例了
	 * @param registry
	 */
	...
	public AnnotatedBeanDefinitionReader(BeanDefinitionRegistry registry, Environment environment) {
		...
		// 关键的一行，注册了六个类，最重要的一个是 ConfigurationClassPostProcessor
